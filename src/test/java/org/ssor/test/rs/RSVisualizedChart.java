...
public class RSVisualizedChart extends ApplicationFrame {
	...
	private static final String title = "Redundant service's performance comparison";
	 ...
	 *            the frame title.
	 */
	public RSVisualizedChart(final String title) {
		super(title);
	...
	private JFreeChart createChart(final CategoryDataset dataset) {
		...
		final JFreeChart chart = ChartFactory.createLineChart(
				title, // chart title
				"Number of threads (requests)", // domain
																	// axis
																	// label
				"Time taken (ms)", // range
																		// axis
	...
	public static void main(final String[] args) {
		...
		recoder.add(new Record("an atomic service with redundant service", 719.0, "3"));
		recoder.add(new Record("an atomic service with redundant service", 1672.0, "9"));
		recoder.add(new Record("an atomic service with redundant service", 3274.0, "15"));
		recoder.add(new Record("an atomic service with redundant service", 4782.0, "21"));
		recoder.add(new Record("an atomic service with redundant service", 6419.0, "27"));
		recoder.add(new Record("an atomic service with redundant service", 6736.0, "33"));
	
	
		recoder.add(new Record("traditional UB", 624.0, "3"));
		recoder.add(new Record("traditional UB", 1387.0, "9"));
		recoder.add(new Record("traditional UB", 2133.0, "15"));
		recoder.add(new Record("traditional UB", 2928.0, "21"));
		recoder.add(new Record("traditional UB", 3586.0, "27"));
		recoder.add(new Record("traditional UB", 4416.0, "33"));

		final RSVisualizedChart demo = new RSVisualizedChart(title);
		demo.pack();
