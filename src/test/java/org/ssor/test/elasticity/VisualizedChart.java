...
public class VisualizedChart extends ApplicationFrame {
	...
	private static final String title = "Elasticity's performance comparison";
	...
	private JFreeChart createChart(final CategoryDataset dataset) {
		...
		final JFreeChart chart = ChartFactory.createLineChart(
				title, // chart title
				"The sequence of requests", // domain
																	// axis
																	// label
				"Time taken (ms)", // range
																		// axis
	...
	public synchronized static boolean record(String name, double timeUsage,
		...
		recoder.add(new Record(name, timeUsage, String.valueOf(Integer.parseInt(numberOfThread))));
